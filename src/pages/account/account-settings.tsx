    ...
    if (del) {
      api
        ...
        .then(() => {
          ...
          setInfo("User successfully deleted");
          setTimeout(() => {
            setInfo("");
            setDel(false);
            navigate("/");
    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="flex flex-wrap flex-col px-5 gap-5 mt-24">
        ...
        <div className="flex flex-col flex-wrap justify-center items-center sm:flex-row">
          ...
          <div className="flex flex-col p-2 gap-2">
            <label id="registrationDate">Registration Date </label>
            <Input
              type="date"
              id="registrationDate"
        ...
        <div className="flex flex-col flex-wrap justify-center p-2 gap-4 sm:flex-row items-center">
          ...
          <Button className="z-0" onClick={handleConfirm}>
            Confirm
          </Button>
        </div>
      </div>
